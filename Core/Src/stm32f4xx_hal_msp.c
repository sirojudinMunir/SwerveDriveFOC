...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC4     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(VBAT_SENS_GPIO_Port, VBAT_SENS_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN6
    */
    HAL_GPIO_DeInit(M2_ISENS_U_GPIO_Port, M2_ISENS_U_Pin);

    HAL_GPIO_DeInit(GPIOA, M2_ISENS_V_Pin|M2_ISENS_W_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC2     ------> ADC3_IN12
    */
    HAL_GPIO_DeInit(GPIOC, M1_ISENS_U_Pin|M1_ISENS_V_Pin|M1_ISENS_W_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA2     ------> TIM5_CH3
    */
    HAL_GPIO_DeInit(GPIOA, M2_HALL_SENS_A_Pin|M2_HALL_SENS_B_Pin|M2_HALL_SENS_C_Pin);
